...
const BUILDER_REGISTRY = {
  ...
  project:     { itemGroups: ["unstructured", "submission"], supportsSections: true, supportsDeliverables: true, supportsMilestones: true },
  observation: { itemGroups: ["observation"], supportsSections: true },
};
