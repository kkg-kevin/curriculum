...
const LearningAreaService = {
  ...
  async createLearningArea(data) {
    const existing = await LearningAreaModel.findAll();
  ...
  async updateLearningArea(id, data) {
    ...
    if (data.name) {
      const all = await LearningAreaModel.findAll();
  ...
  async deleteLearningArea(id) {
    ...
    await CourseLearningAreaLinkModel.deleteByLearningAreaId(id);
    await AssessmentLearningAreaLinkModel.deleteByLearningAreaId(id);
  },
};
