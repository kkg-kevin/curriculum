...
// A hub card for the "pick a hub first" entry point shared by Classes/Teachers/Learners.
// Clicking anywhere on the card drills into that hub's scoped list for the module. Classes and
// Learners still only attach to school-type hubs, so those callers pre-filter to hubType
// "school" before rendering these cards — Teachers can now attach to any hub type, so its
// caller passes every active hub instead.
