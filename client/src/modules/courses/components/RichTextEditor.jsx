  ...
  return (
    <div style={{ border: "1.5px solid #E5E7EB", borderRadius: "10px", overflow: "hidden", backgroundColor: "#F9FAFB" }}>
      <style>{`
        ...
        .rte-content table { border-collapse: collapse; width: 100%; margin: 0 0 10px; table-layout: fixed; }
        .rte-content th, .rte-content td { border: 1.5px solid #E5E7EB; padding: 6px 9px; text-align: left; vertical-align: top; position: relative; }
        .rte-content th { background: #F9FAFB; font-weight: 700; }
        .rte-content .selectedCell { background: #e8f5fb; }
        .rte-content .column-resize-handle { position: absolute; right: -2px; top: 0; bottom: 0; width: 4px; background: #38aae1; pointer-events: none; }
      `}</style>
