...
import { INVENTORY_CATEGORIES } from "../../settings/inventory/constants";
        ...
        <div style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. LEGO Mindstorms Kit"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            <div>
              ...
              <select
                ...
                style={{ width: "100%", boxSizing: "border-box", padding: "9px 11px", borderRadius: "9px", border: "1.5px solid #E5E7EB", fontSize: "13px", fontFamily: "Inter, sans-serif", outline: "none", background: "#fff" }}
              >
