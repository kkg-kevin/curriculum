          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: 13, color: "rgba(255,255,255,0.72)" }}>
                {school?.address?.county ? `${school.address.county} County · ` : ""}Teachers
              </p>
            </div>
          </div>
          <button
      ...
      {teachersLoading ? (
        ...
        <div style={{ textAlign: "center", padding: "64px 24px", backgroundColor: "#ffffff", borderRadius: 16, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
          ...
          <h3 style={{ margin: "0 0 8px", fontSize: 18, fontWeight: 700, color: "#111827" }}>
            {statusFilter ? "No teachers match the filter" : `No teachers for ${school?.name || "this school"} yet`}
          </h3>
          <p style={{ margin: "0 0 24px", fontSize: 14, color: "#6B7280", lineHeight: 1.6 }}>
            {statusFilter ? "Try clearing the filter to see all teachers." : "Add the first teacher for this school."}
          </p>
          {statusFilter
