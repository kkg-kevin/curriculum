...
export const competitionApi = {
  ...
  // Hub-offerings — "run this competition at a hub". Replaces the old standalone Event-
  // deployment flow; nested under the competition since an offering has no identity outside
  // its parent.
